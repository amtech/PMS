...
<div id="mainLayout" class="easyui-layout hidden" fit="true">
	<div region="north" border="true" class="cs-north">
		...
		<div style="float: left;">
			<img alt="portrait" src="<%=path%>/images/portrait.jpg" style="max-height: 88px; margin-bottom: -8px;"/>
		</div>
		<div align="center">
			<img alt="header_c" src="<%=path%>/images/header_c.jpg" style="max-height: 88px; margin-top: 2px;"/>
		</div>
		<div style="float: right; margin: -80px 5px 0px 0px;">
			<input type="text" id="themes" class="easyui-combobox" /><br>
			<a id="updatePass" href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-man',plain:true">修改密码</a><br>
			<a id="exitSystem" href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-exit',plain:true">退出系统</a>
		</div>
	</div>
	...
	<div region="east" border="true" split="true" title="日历" class="cs-east">
		<div><div id="cc" style="float:right; width:250px; height:250px;"></div></div>
		<div><table id="memGrid"></table></div>
	</div>
	<div region="south" border="false" id="south"><center>jQuery EasyUI 1.4 Demo</center></div>
	
	<div id="updatePassword" class="easyui-dialog" data-options="closed: true">
		<form id="pwd_form" method="post">
			<table width="100%;" align="center" border="0" style="padding: 5px;">
				<tr>
					<td align="right">旧密码：</td>
					<td><input type="password" id="oldpwd" name="oldpwd" class="easyui-textbox" data-options="required:true" missingMessage="旧密码必须填写"></td>
				</tr>
				<tr>
					<td align="right">新密码：</td>
					<td><input type="password" id="newpwd" name="newpwd" class="easyui-textbox" data-options="required:true" missingMessage="新密码必须填写"></td>
				</tr>
				<tr>
					<td align="right">确认新密码：</td>
					<td><input type="password" id="newpwd2" name="newpwd2" class="easyui-textbox" data-options="required:true" missingMessage="确认新密码必须填写" validType="equals['#newpwd']"></td>
				</tr>
			</table>
		</form>
	</div>
