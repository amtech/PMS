...
<div class="modal-dialog">
	<div class="modal-content">
		...
		<form id="user_fmt" role="form" class="form-horizontal">
		<input type="hidden" name="id" id="editId" value="${user.id}">
		<div class="modal-body">
			<div class="form-group">
				<div class="col-xs-6 col-sm-3">
					<label class="col-sm-12 control-label no-padding-right" for="username">帐号名称</label>
				</div>
				<div class="col-xs-6 col-sm-9">
					<input type="text" name="username" id="username" class="col-xs-12 col-sm-8" placeholder="请输入帐号名称" value="${user.username }"/>
				</div>
			</div>
			<div class="form-group">
				<div class="col-xs-6 col-sm-3">
				...
				<div class="col-xs-6 col-sm-9">
					<input type="text" name="realname" id="realname" class="col-xs-12 col-sm-8" placeholder="请输入真实名" value="${user.realname }"/>
				</div>
			</div>
			<div class="form-group">
				<div class="col-xs-6 col-sm-3">
			...
			<div class="form-group">
				...
				<div class="col-xs-6 col-sm-9">
					<input type="text" name="email" id="email" class="col-xs-12 col-sm-8" placeholder="请输入Email" value="${user.email }"/>
				</div>
			</div>
		</div>
