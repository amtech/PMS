		...
		<div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix">
			<span id="ui-id-26" class="ui-dialog-title">
				<div class="widget-header widget-header-small">
					<h4 class="smaller">
						<i class="icon-ok" id="input-title">选择角色</i>
					</h4>
				</div>
			</span>
		</div>
		<form id="selectRole_fmt" role="form" class="form-horizontal">
		<input type="hidden" name="userId" id="userId">
		<input type="hidden" id="roleIds" name="roleIds" value="${roleIds }">
		<div class="modal-body">
			<div id="role_tree" class="tree tree-selectable"></div>
		</div>
		<div class="modal-footer">
			<div class="col-md-offset-3 col-md-9">
				<button class="btn btn-sm btn-primary" type="button" id="save_selectRole_btn">
