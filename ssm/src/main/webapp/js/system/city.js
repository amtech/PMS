	...
	loadPage:function(){
		...
		jQuery("#grid-table").jqGrid({
			...
			colModel:[
				...
				{name:'cityType',index:'cityType',width:50,editable:false,formatter: "select",editoptions:{value:"1:省/自治区/直辖市;2:地级市;3:区县"}},
