package com.cjhb.ssm.credit.comm.util.page;
...
import com.credit.comm.util.interceptor.PaginationInterceptor;
...
public class PageForJqGrid<T> {
	...
	public PageForJqGrid<T> listToPage(PageForJqGrid<T> page,List<T> list){
		page.setRecords(PaginationInterceptor.getResultCount());
		page.setResult(list);
